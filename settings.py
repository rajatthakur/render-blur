...
g_spheres_path = "/cluster/home/denysr/scratch/dataset/sphere.zip"
...
if not os.path.exists(g_shapenet_path):
	...
	g_spheres_path = "/home/denysr/data/sphere.zip"
...
if not os.path.exists(g_shapenet_path):
	...
	g_spheres_path = "/home/rozumden/data/sphere.zip"
	g_texture_path = "/home/rozumden/data/textures.zip"
	g_blender_path = r"/home/rozumden/Programs/blender-2.91.0-linux64/blender"
